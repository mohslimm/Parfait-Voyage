      ...
      <div className="container-custom py-16">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-6">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="font-display text-accent text-xs tracking-[0.2em] uppercase">Voyages</span>
              </div>
            </Link>
        ...
        <div className="mt-8 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link to="/privacy" className="text-white/30 hover:text-white/60 text-xs font-body transition-colors">Politique de confidentialité</Link>
            <Link to="/cgv" className="text-white/30 hover:text-white/60 text-xs font-body transition-colors">CGV</Link>
            <Link to="/contact" className="text-white/30 hover:text-white/60 text-xs font-body transition-colors">Mentions légales</Link>
          </div>
        </div>
      </div>
    </footer>
