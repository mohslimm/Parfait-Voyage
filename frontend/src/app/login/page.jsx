          ...
          <div className="mb-10 text-center lg:text-left">
            <Link href="/" className="inline-block mb-8">
              <span className="font-display text-2xl font-bold tracking-tighter">
                PARFAIT <span className="text-primary">VOYAGE</span>
              </span>
            </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {isRegister && (
              <motion.div variants={fadeInUp} initial="hidden" animate="visible">
                ...
                <input
                  ...
                  className="w-full px-5 py-4 bg-white border border-[#E8E2D9] rounded-2xl focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all font-body"
                  value={formData.name}
            ...
            <div className="flex items-center justify-between text-sm font-body">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-[#E8E2D9] text-primary focus:ring-primary" />
