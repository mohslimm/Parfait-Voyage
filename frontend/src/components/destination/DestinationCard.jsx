...
import { Badge, StarBadge } from '@/components/ui/Badge'
    ...
    <Link href={`/destinations/${d.id}`} className="block">
      ...
      >
        ...
        <div className="relative h-56 overflow-hidden">
          {/* Skeleton (will be hidden by the image when it loads since image is above it without opacity:0) */}
        ...
        <div className="p-5">
          ...
          <div className="mb-3 flex">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-red-50 border border-red-100 text-red-600 text-[10px] font-bold uppercase tracking-wider animate-pulse">
              <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              {d.id % 2 === 0 ? "3 places restantes" : "Départ dans 12 jours"}
            </span>
          </div>
