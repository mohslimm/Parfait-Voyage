...
import planeImg from '../../assets/plane-removebg.png'
...
export function SplashScreen({ finishLoading }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(0,98,51,0.1),transparent_50%)]" />
      ...
      >
        <span className="font-display text-5xl md:text-8xl font-bold text-white tracking-tighter block text-center">
