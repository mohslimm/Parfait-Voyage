          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-[#0A0A0F]/70 font-body text-lg leading-relaxed">
                <p>
                  Fondée en 2012, <span className="font-semibold text-[#006233]">Parfait Voyage</span> est née d'une volonté simple : offrir aux voyageurs algériens une expérience de voyage premium, sans compromis sur la qualité et la transparence.
                </p>
                <p>
              ...
              <div className="grid grid-cols-2 gap-8 mt-10">
                <div>
                  <p className="font-display text-4xl font-bold text-[#006233]">12+</p>
                  <p className="text-sm font-body text-[#0A0A0F]/50">Années d'excellence</p>
                </div>
                <div>
                  <p className="font-display text-4xl font-bold text-[#006233]">50k+</p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="/destinations"
                className="px-8 py-4 bg-[#006233] text-white rounded-2xl font-bold font-body text-lg hover:bg-[#007a3f] transition-all shadow-premium"
              >
                Explorer nos offres
              </a>
              <a
