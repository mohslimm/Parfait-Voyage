...
export default function Contact() {
  ...
  return (
    <div className="bg-[#FAF7F2] pt-24 pb-20">
      {/* Header */}
      <section className="bg-gradient-to-br from-[#006233] to-[#004d27] py-20 text-center">
            ...
            {[
              {
                icon: '📍',
                title: 'Notre Siège',
                content: '12 Rue Didouche Mourad, Alger Centre, Algérie',
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-5 py-4 bg-[#FAF7F2] border border-[#E8E2D9] rounded-2xl focus:outline-none focus:border-[#006233] transition-all font-body"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select className="w-full px-5 py-4 bg-[#FAF7F2] border border-[#E8E2D9] rounded-2xl focus:outline-none focus:border-[#006233] transition-all font-body appearance-none">
              ...
              <div>
                ...
                <textarea
                  required
                  rows="5"
                  className="w-full px-5 py-4 bg-[#FAF7F2] border border-[#E8E2D9] rounded-2xl focus:outline-none focus:border-[#006233] transition-all font-body resize-none"
              ...
              <motion.button
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full py-5 bg-[#006233] text-white rounded-2xl font-bold font-body text-lg hover:bg-[#007a3f] transition-all shadow-premium"
              >
                Envoyer le message
              </motion.button>
            </form>
